/* CRIAÇÃO DO Schema e suas respectivas tabelas
Create schema if not exists sucos;

create table tbcliente (CPF Varchar(11));
create table tbproduto(Produto Varchar (20));
*/
USE sucos;
